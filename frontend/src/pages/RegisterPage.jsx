            ...
            <Box sx={{ p: 4, boxShadow: 3, borderRadius: 2, bgcolor: "background.paper" }}>
                ...
                <Box component="form" onSubmit={handleSubmit} noValidate>
                    ...
                    <TextField
                        ...
                        onChange={handleChange}
                        error={!!errors.password && formData.password.length > 0 && !isPasswordValid}
                    ...
                    {formData.password.length > 0 && (
                        <Box sx={{ mt: 1, mb: 2, pl: 1 }}>
                            ...
                            <List dense disablePadding>
                                <RequirementItem met={passwordChecks.length} text={`At least ${MIN_LENGTH} characters`} />
                                <RequirementItem met={passwordChecks.uppercase} text="One uppercase letter (A-Z)" />
                                <RequirementItem met={passwordChecks.lowercase} text="One lowercase letter (a-z)" />
                                <RequirementItem met={passwordChecks.number} text="One number (0-9)" />
                                <RequirementItem met={passwordChecks.special} text={`One special character (${SPECIAL_CHARS})`} />
                                <RequirementItem met={passwordChecks.maxLength} text={`Maximum ${MAX_LENGTH} characters`} />
                            </List>
                        </Box>
                    )}
                    ...
                    <TextField
                        ...
                        sx={{
                            '& .MuiFormHelperText-root': {
                                color: !passwordsMatch && formData.confirmPassword !== '' ? 'error.main' : 'inherit',
                                fontWeight: !passwordsMatch && formData.confirmPassword !== '' ? 'bold' : 'normal'
                            }
                        }}
                    />
                    ...
                    <Button
                        ...
                        disabled={loading || (formData.password.length > 0 && !isPasswordValid) || !passwordsMatch}
                    >
